...
namespace machine::assembler {
	...
	void disassemble(const bytecode_t& bytecode, machine::simple_program_t& out, size_t start = 0, size_t end = SIZE_MAX);
	void disassemble_unsafe(const bytecode_t& bytecode, machine::instruction_t& out, size_t& pc);
	void disassemble_unsafe(const bytecode_t& bytecode, machine::simple_program_t& out, size_t start = 0, size_t end = SIZE_MAX);
}
